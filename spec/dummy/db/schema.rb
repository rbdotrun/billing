...
ActiveRecord::Schema[7.1].define(version: 2024_03_18_104108) do
  ...
  create_table "billing_manager_prices", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.enum "usage_type", default: "licensed", null: false, enum_type: "usage_type"
    t.string "stripe_id"
    t.jsonb "stripe_data"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "billing_manager_record_usages", force: :cascade do |t|
